...
INSERT INTO `bookings` (`id`, `client_id`, `package_id`, `staff_id`, `event_date`, `start_at`, `end_at`, `address`, `location_latlon`, `status`, `subtotal`, `discount`, `total`, `dp_amount`, `dp_paid_at`, `created_at`, `updated_at`) VALUES
('30000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000003', '21000000-0000-0000-0000-000000000001', '10000000-0000-0000-0000-000000000001', '2025-09-20', '2025-09-20 02:00:00.000', '2025-09-20 04:00:00.000', 'Studio A, Jakarta', NULL, 'INQUIRY', 750000, 0, 750000, 150000, NULL, '2025-09-03 23:40:11.890', '2025-09-03 23:40:11.890');
...
-- (hapus data time_blocks)

--
-- Trigger `time_blocks`
--
DELIMITER $$
-- CREATE TRIGGER `trg_tb_no_overlap_insert` ... (dihapus)
  IF EXISTS (
...
DELIMITER ;
DELIMITER $$
-- CREATE TRIGGER `trg_tb_no_overlap_update` ... (dihapus)
  IF EXISTS (
    SELECT 1 FROM time_blocks t
    WHERE t.staff_id = NEW.staff_id
      AND t.id <> NEW.id
...
ALTER TABLE `bookings`
  ...
  ADD KEY `idx_bookings_staff` (`staff_id`);
...
ALTER TABLE `bookings`
  ...
  ADD CONSTRAINT `fk_bookings_staff` FOREIGN KEY (`staff_id`) REFERENCES `staff` (`id`) ON DELETE SET NULL;
